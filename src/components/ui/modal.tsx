  ...
  <ModalPortal>
    ...
    >
      ...
      >
        <Button
          variant="ghost"
          className="inline-flex h-8 w-8 items-center rounded-xl border border-input p-0 text-xs font-semibold text-zinc-900 transition-colors hover:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
        >
          <X className="h-5 w-5" />
